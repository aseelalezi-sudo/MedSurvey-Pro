...
Route::prefix('settings')->group(function (): void {
    ...
    Route::put('/', [SettingsController::class, 'update'])->middleware(['auth:api', 'audit.mutations', 'role:super_admin,admin']);
...
Route::prefix('surveys')->group(function (): void {
    ...
    Route::post('/', [SurveyController::class, 'store'])->middleware(['auth:api', 'audit.mutations', 'role:super_admin,admin']);
    Route::put('/{id}', [SurveyController::class, 'update'])->middleware(['auth:api', 'audit.mutations', 'role:super_admin,admin']);
    Route::delete('/{id}', [SurveyController::class, 'destroy'])->middleware(['auth:api', 'audit.mutations', 'role:super_admin,admin']);
});
...
Route::prefix('tickets')->middleware(['auth:api', 'audit.mutations'])->group(function (): void {
...
Route::prefix('users')->middleware(['auth:api', 'audit.mutations'])->group(function (): void {
...
Route::prefix('error-logs')->group(function (): void {
    ...
    Route::middleware(['auth:api', 'audit.mutations', 'role:super_admin,admin'])->group(function (): void {
    ...
    Route::delete('/', [ErrorLogController::class, 'clearAll'])->middleware(['auth:api', 'audit.mutations', 'role:super_admin']);
    Route::delete('/{id}', [ErrorLogController::class, 'destroy'])->middleware(['auth:api', 'audit.mutations', 'role:super_admin']);
});
