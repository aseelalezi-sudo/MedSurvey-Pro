...
<div
  x-data="settingsManager({
    texts: {
      ...
      tabs: {
        hospital: @js(__('settings_tab_hospital')),
        departments: @js(__('settings_tab_departments')),
        ageGroups: @js(__('settings_tab_age_groups')),
        visitTypes: @js(__('settings_tab_visit_types')),
        survey: @js(__('settings_tab_survey')),
        appearance: @js(__('settings_tab_appearance')),
        backup: @js(__('settings_tab_backup')),
      },
    },
