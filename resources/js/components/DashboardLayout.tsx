              ...
              <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
                ...
                {currentUser && (
                  <div className="relative" ref={dropdownRef}>
                    ...
                    >
                      <div className={`w-8 h-8 rounded-full bg-linear-to-r ${getRoleGradient(currentUser.role)} flex items-center justify-center text-white text-xs font-black shadow-md shadow-indigo-100 dark:shadow-none transition-transform group-hover:scale-105`}>
                    ...
                    {showProfileDropdown && (
                      <div className="absolute end-0 top-full mt-2 w-[min(18rem,calc(100vw-2rem))] bg-white/95 dark:bg-slate-900/95 backdrop-blur-md rounded-2xl shadow-xl border border-gray-150 dark:border-slate-800/80 py-3 z-[80] animate-scale-in origin-top">
                        ...
                        <div className="px-4 py-3 border-b border-gray-50 dark:border-slate-850/60 flex flex-col items-center text-center">
                          <div className={`w-14 h-14 rounded-2xl bg-linear-to-r ${getRoleGradient(currentUser.role)} flex items-center justify-center text-white text-lg font-black shadow-lg shadow-indigo-100 dark:shadow-none mb-3`}>
                            {getUserInitials(currentUser.name)}
                          </div>
