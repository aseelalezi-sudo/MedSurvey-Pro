...
export default function TextQuestion({ value, onChange, placeholder = 'اكتب إجابتك هنا...' }: TextQuestionProps) {
  return (
    <div className="py-4">
      ...
      <div className="text-left mt-2">
        <span className="text-xs text-gray-400">{value.length} / 500 حرف</span>
      </div>
    </div>
  );
}
