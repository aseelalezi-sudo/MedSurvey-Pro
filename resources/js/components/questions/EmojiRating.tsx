...
const emojis = [
  { value: 1, emoji: '😡', labelKey: 'emoji_very_bad', color: 'bg-red-100 border-red-300 text-red-500' },
  { value: 2, emoji: '😕', labelKey: 'emoji_bad', color: 'bg-orange-100 border-orange-300 text-orange-500' },
  { value: 3, emoji: '😐', labelKey: 'emoji_average', color: 'bg-yellow-100 border-yellow-300 text-yellow-600' },
  { value: 4, emoji: '😊', labelKey: 'emoji_good', color: 'bg-lime-100 border-lime-300 text-lime-600' },
  { value: 5, emoji: '😍', labelKey: 'emoji_excellent', color: 'bg-green-100 border-green-300 text-green-500' },
];
