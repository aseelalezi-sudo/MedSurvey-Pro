...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    // We import echo inside the effect to avoid breaking tests if echo is not fully mocked
    import('../echo').then((module) => {
      ...
      channel.listen('SurveySubmitted', (e: LiveSurveyResponse) => {
        ...
        if (!dept || e.department === dept) {
          setLiveResponse(e);
          loadDashboardData(dept);
          setTimeout(() => setLiveResponse(null), 5000);
        }
      });
    });
  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-linear-to-r from-slate-900 via-indigo-950 to-slate-900 text-white rounded-2xl p-4 sm:p-5 mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between border border-indigo-500/20 relative overflow-hidden group gap-4">
          {/* Glowing background */}
        ...
        {currentUser?.role === 'head_of_department' && currentUser.department && (
          <div className="bg-linear-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 border border-blue-200 dark:border-blue-900/40 rounded-2xl p-4 mb-6 flex items-center gap-3 animate-slide-up text-start">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 text-start">
              ...
              >
                ...
                <div className="w-full h-2 bg-gray-100 dark:bg-slate-800 rounded-full overflow-hidden">
                  <div className="h-full bg-linear-to-r from-teal-500 to-emerald-500 rounded-full transition-all duration-500" style={{ width: `${nameResponsesRate}%` }} />
                </div>
              </div>
              ...
              >
                ...
                <div className="w-full h-2 bg-gray-100 dark:bg-slate-800 rounded-full overflow-hidden">
                  <div className="h-full bg-linear-to-r from-blue-500 to-indigo-500 rounded-full transition-all duration-500" style={{ width: `${phoneResponsesRate}%` }} />
                </div>
              </div>
            </div>
              ...
              {[
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <div className={`w-12 h-12 bg-linear-to-r ${stat.color} rounded-xl flex items-center justify-center shadow-lg ${stat.shadow}`}>
        ...
        {(permissions?.canManageSurveys || permissions?.canManageUsers) && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 text-start">
            {permissions?.canManageSurveys && (
              <div className="bg-linear-to-r from-teal-600 to-emerald-600 rounded-2xl p-6 text-white shadow-lg shadow-teal-200 dark:shadow-teal-950/20">
            ...
            {permissions?.canManageUsers && (
              <div className="bg-linear-to-r from-purple-600 to-indigo-600 rounded-2xl p-6 text-white shadow-lg shadow-purple-200 dark:shadow-purple-950/20">
                <div className="flex items-center justify-between flex-wrap gap-4">
                  <div>
        ...
        {permissions?.canManageSurveys && (
          <div className="bg-linear-to-r from-gray-600 to-gray-700 rounded-2xl p-6 text-white mb-6 shadow-lg shadow-gray-200 dark:shadow-slate-950/20">
          ...
          {currentUser?.role === 'head_of_department' && currentUser.department ? (() => {
            ...
            return (
              <div className="relative group overflow-hidden bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800/80 shadow-sm p-5 transition-all hover:-translate-y-1 hover:shadow-md max-w-md">
                <div className={`absolute top-0 right-0 w-16 h-16 bg-linear-to-r ${gradientColor} opacity-10 rounded-bl-full pointer-events-none`} />
                <div className="flex items-center gap-4">
                  <div className={`w-12 h-12 rounded-xl bg-linear-to-r ${gradientColor} flex items-center justify-center text-white shadow-lg`}>
              ...
              {stats.departmentScores.slice(0, 3).map((dept, index) => {
                ...
                return (
                  <div key={dept.name} className="relative group overflow-hidden bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800/80 shadow-sm p-5 transition-all hover:-translate-y-1 hover:shadow-md">
                    <div className={`absolute top-0 right-0 w-16 h-16 bg-linear-to-r ${colors[index]} opacity-10 rounded-bl-full`} />
                    <div className="flex items-center gap-4">
                      <div className={`w-12 h-12 rounded-xl bg-linear-to-r ${colors[index]} flex items-center justify-center text-white shadow-lg`}>
                        <IconComp className="w-6 h-6" />
                      </div>
                      <div>
        ...
        {liveResponse && (
          <div className="fixed bottom-6 right-6 sm:w-96 bg-white dark:bg-slate-900 border-l-4 border-l-teal-500 rounded-2xl p-4 shadow-2xl dark:shadow-teal-500/10 animate-slide-up flex gap-3 items-start z-50 overflow-hidden group">
            <div className="absolute inset-0 bg-teal-500/5 opacity-0 group-hover:opacity-100 transition-opacity" />
            <div className="w-10 h-10 bg-teal-50 dark:bg-teal-500/10 rounded-xl flex items-center justify-center text-teal-500 shrink-0">
