    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 dark:from-[#09101d] dark:via-[#080c14] dark:to-[#0a1424] flex items-center justify-center p-4 relative text-gray-900 dark:text-slate-100 transition-colors duration-300">
      ...
      <div className="text-center max-w-lg animate-scale-in">
        ...
        <div className="relative mb-8">
          <div className="w-28 h-28 mx-auto bg-gradient-to-br from-green-400 to-emerald-500 rounded-full flex items-center justify-center shadow-2xl shadow-green-200 dark:shadow-green-950/20 animate-pulse">
        ...
        {medicalTip ? (
          <div className="bg-gradient-to-br from-teal-500 to-emerald-600 rounded-3xl p-8 mb-8 text-white shadow-xl shadow-teal-200 dark:shadow-teal-950/20 relative overflow-hidden group">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <button
            onClick={onHome}
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-l from-teal-600 to-emerald-600 text-white rounded-xl font-bold shadow-lg shadow-teal-200 dark:shadow-teal-950/20 hover:shadow-xl hover:-translate-y-0.5 transition-all cursor-pointer"
          >
