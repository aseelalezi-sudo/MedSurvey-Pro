...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-blue-50 dark:from-[#080d1a] dark:via-[#0c1224] dark:to-[#0a1020] text-gray-900 dark:text-slate-100 transition-colors duration-300 animate-fade-in">
      {/* Header */}
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 min-w-0">
                {settings.hospital.logo ? (
                  <img
                    ...
                    className="h-8 max-w-[64px] sm:max-w-[120px] object-contain rounded-lg p-0.5 border border-gray-100 dark:border-slate-800 bg-gray-50/50 dark:bg-slate-900/50 shrink-0"
                  />
                ) : (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className={`w-14 h-14 bg-gradient-to-br ${feature.color} rounded-2xl flex items-center justify-center text-white shadow-lg ${feature.shadow} mb-5 group-hover:scale-110 transition-transform`}>
                  {feature.icon}
                </div>
