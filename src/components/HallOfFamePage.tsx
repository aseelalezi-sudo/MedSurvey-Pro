        ...
        myDeptData ? (
          <div className="max-w-4xl mx-auto space-y-8 animate-fade-in mt-6">
            ...
            <div className={`relative overflow-hidden rounded-3xl p-8 text-white shadow-2xl transition-all duration-500 ${
              (myDeptIndex + 1) === 1 ? 'bg-linear-to-r from-yellow-500 via-amber-500 to-yellow-600 shadow-yellow-200 border border-yellow-400' :
              (myDeptIndex + 1) === 2 ? 'bg-linear-to-r from-slate-400 via-slate-500 to-slate-600 shadow-slate-200 border border-slate-300' :
              (myDeptIndex + 1) === 3 ? 'bg-linear-to-r from-orange-400 via-amber-600 to-amber-700 shadow-amber-200 border border-orange-500' :
              'bg-linear-to-r from-teal-600 via-emerald-600 to-teal-700 border border-teal-500'
            }`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
                ...
                {topThree[0] && (
                  <div className="order-1 md:order-2 flex flex-col items-center mb-6 md:mb-0 scale-110">
                    ...
                    <div className="bg-linear-to-r from-yellow-500 to-yellow-600 rounded-3xl p-6 w-full text-center shadow-xl border-2 border-yellow-450">
